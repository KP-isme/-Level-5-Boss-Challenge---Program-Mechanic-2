...
var score = 0;
	...
	platform0 = new GameObject();
		...
		platform0.color = "#4f00ce";
		platform0.y = canvas.height-300;
	...
	platform1 = new GameObject();
		...
		platform1.color = "#1e72a9";
		
	platform2 = new GameObject();
		platform2.width = canvas.width-300;
		platform2.x = platform0.width/2;
		platform2.y = platform0.y- 400;
		platform2.color = "#4f00ce";

	platform3 = new GameObject();
		platform3.width = canvas.width-300;
		platform3.x = platform0.width/2;
		platform3.y = platform0.y+ 220;
		platform3.color = "#4f00ce";
	
	goal = new GameObject({width:24, height:50, x:20, y:platform0.y-100, color:"#fadb0d"}); 
...
function animate()
{
	...
	if (key && player.hitTestObject(platform1))
	{
		score ++;
		// platform1.y = 10000;
	}
